...
public class book9 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMenu = findViewById(R.id.button9_1);
        buttonOrder = findViewById(R.id.button9);
